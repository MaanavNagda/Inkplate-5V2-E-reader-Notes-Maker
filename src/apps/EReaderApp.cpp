...
namespace {
    ...
    constexpr uint16_t CHAR_W = 16;              // FreeSans15pt7b average xAdvance
    constexpr uint16_t CHAR_H = 35;              // FreeSans15pt7b yAdvance (line height)
...
void EReaderApp::drawReader(Inkplate& display) {
    ...
    statusRow_.draw(display, darkMode_, false);
    drawPageCounter(display);
}

void EReaderApp::drawPageCounter(Inkplate& display) {
